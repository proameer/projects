...
{
    $q=mysqli_query($conn,"SELECT BookName ,CtegoryName,AuthorName ,ISBNNumber,quantity FROM book JOIN category ON book.CategoryId=category.id_c JOIN authors ON AuthorId=authors.id_au where BookName like '%$_POST[search]%' ORDER BY id_b desc;");
...
?>
                ...
                <td><?php echo $row['CtegoryName'] ; ?> </td>
                <td><?php echo $row['AuthorName'] ; ?> </td>
                <td><?php echo $row['ISBNNumber'] ; ?> </td>
                <td><?php echo $row['quantity'] ; ?> </td>
                <td><a href="manage-book.php?id_b=<?php echo $row['id_b'];?>"><button
                            style="padding: 5px 20px;" class="btn btn-danger">حذف
                        </button></a> </td>
                <td><a href="edit-book.php?id_b=<?php echo $row['id_b'];?>"><button
...
if(isset($_POST['search'])){
    ...
    $query="SELECT id_b,BookName ,CtegoryName,AuthorName ,ISBNNumber,quantity FROM book JOIN category ON book.CategoryId=category.id_c JOIN authors ON AuthorId=authors.id_au ORDER BY id_b desc";
}
...
if(isset($_GET['id_b'])){
    $id=$_GET['id_b'];
$query="DELETE FROM `book` WHERE id_b= '$id'";
