                ...
                <form class="login100-form validate-form" action="" method="POST">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input style="  text-align: right;" class="input100" type="email" name="email"
                            placeholder="البريد الالكتروني"value="<?php echo $row['AdminEmail']; ?>">
                        <span class="focus-input100"></span>
                    </div>
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $email = $_POST['email'];
                    $password = $_POST['pass'];
                    $query1 = "UPDATE admin SET FirstName='$firstname',lastName='$lastname',AdminEmail='$email',Password='$password' WHERE id_a = '$id'";
                    // echo "ffffff".$id;
