...
{
    $q=mysqli_query($conn,"SELECT * from category where CtegoryName like '%$_POST[search]%' ORDER BY id_c desc");
...
?>
                ...
                <td><a href="manage-categories.php?id=<?php echo $row['id_c'];?>"><button
                            style="padding: 5px 20px;" class="btn btn-danger">حذف
                        </button></a> </td>
                <td><a href="edit-categories.php?id_c=<?php echo $row['id_c'];?>"><button
...
<?php
    $count=0;
    $q=mysqli_query($conn,"SELECT * from category ORDER BY id_c desc");
    while($row=mysqli_fetch_assoc($q))
...
<tr>
                ...
                <td><?php echo $row['CreationDate'] ; ?> </td>
                <td><?php echo $row['UpdationDate'] ; ?> </td>
                <td><a href="manage-categories.php?id_c=<?php echo $row['id_c'];?>"><button
                            style="padding: 5px 20px;" class="btn btn-danger">حذف
                        </button></a> </td>
                <td><a href="edit-categories.php?id_c=<?php echo $row['id_c'];?>"><button
                            style="padding: 5px 20px;" class="btn btn-success">تعديل
...
if(isset($_GET['id_c'])){
    $id=$_GET['id_c'];
$query="DELETE FROM `category`WHERE id_c= '$id'";
