    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo" style="margin-left: 40%;">
                ...
                <h1><a href="index.php"><span>مكتبة الكترونية </span></a></h1>
            ...
            <ul class="navbar-nav float-right">
                ...
                <li style="margin: 0 auto;" class="nav-item dropdown">
                    <a style="direction:rtl;" class="nav-link dropdown-toggle" href="javascript:void(0)"
                        ...
                        <span class="ml-2 d-none d-lg-inline-block text-light"><span>انضم</span>
                            <span class="text-light"></span> <i data-feather="chevron-down" class="svg-icon"></i></span>
                        <img src="assets/img/user.jpg" alt="user" class="rounded-circle " width="40">
                    </a>
                    <div style="text-align: right;padding: 0px 0px;margin: 0 2%;min-width: 140px;"
                        class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        <a class="dropdown-item" href="form/login.php"><i data-feather="user"
                                class="svg-icon mr-2 ml-1"></i>
                            تسجيل الدخول</a>


                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="form/register.php"><i data-feather="power"
                                class="svg-icon mr-2 ml-1"></i>
                            انشاء حساب</a>
                    </div>
                </li>
                ...
                <div class="row">
                    ...
                    <div style="text-align: right;"
                        ...
                        <h3>هي عبارة عن مكتبة تعمل على تقنيات إلكترونية حديثة تتسم بالكفاءة والفعالية وتقوم بمجموعة من
                            ...
                            <div style="text-align: right;" class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                                <!-- <div class="icon"><i class="bx bx-fingerprint"></i></div> -->
                                <h4 style="font-size: 30px; color: #000;" class="title">البحث فيها سريع النتيجة وعالي
                                    الدقة</h4>
                            </div>
                                    ...
                                    <div class="col-md-6 col-lg-3 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="p-2  text-center" style="background-color: #25373A; ">
                                                ...
                                                <form method="post">
                                                    <input hidden="true" class="btn btn-primary" type="text"
                                                        value="<?php echo $row['id_b'];?>" name="iss">
                                                    <input class="btn btn-primary" type="submit" name="iss"
                                                        value="أستعارة"
                                                        onclick="alert('سجل الدخول اولا لتتمكن من الاستعارة');">
                                                    <!-- <a href="form/login.php" class="btn btn-primary">استعارة</a> -->
...
?>
                ...
                <div class="row no-gutters" data-aos="fade-left">
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100">
                            <a href="assets/img/gallery/gallery-1.jpg" class="gallery-lightbox">
                                <img src="assets/img/libr7.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="150">
                            <a href="assets/img/libr1.jpg" class="gallery-lightbox">
                                <img src="assets/img/libr.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="200">
                            <a href="assets/img/gallery/gallery-3.jpg" class="gallery-lightbox">
                                <img src="assets/img/libr10.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="250">
                            <a href="assets/img/gallery/gallery-4.jpg" class="gallery-lightbox">
                                <img src="assets/img/libr3.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
                            <a href="assets/img/gallery/gallery-5.jpg" class="gallery-lightbox">
                                <img src="assets/img/libr5.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="350">
                            <a href="assets/img/gallery/gallery-6.jpg" class="gallery-lightbox">
                                <img src="assets/img/libr4.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="400">
                            <a href="assets/img/gallery/gallery-7.jpg" class="gallery-lightbox">
                                <img src="assets/img/libr8.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
                            <a href="assets/img/libr7.jpg" class="gallery-lightbox">
                                <img src="assets/img/libr12.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="member" data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <div class="member-info">
                                ...
                                <div class="social">
                                    ...
                                    <a href="https://www.facebook.com/profile.php?id=100008116308759"><i
                                            class="bi bi-facebook"></i></a>
                                    <a href="https://instagram.com/akram_turkmani?utm_medium=copy_link"><i
                        ...
                        <div class="member" data-aos="zoom-in" data-aos-delay="300">
                            ...
                            <div class="member-info">
                                ...
                                <div class="social">
                                    ...
                                    <a href="https://instagram.com/pro_ameer?utm_medium=copy_link"><i
                                            class="bi bi-instagram"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 mt-5 mt-md-0">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            <div class="member-info">
                                ...
                                <div class="social">
                                    <!-- <a href=""><i class="bi bi-google"></i></a> -->
                                    <a href="https://www.facebook.com/ahmed.alkarbala.9"><i
                                            class="bi bi-facebook"></i></a>
                                    <a href="https://instagram.com/prog_a98?utm_medium=copy_link"><i
                                            class="bi bi-instagram"></i></a>
    ...
    <footer id="footer">
        ...
        <div class="container">
            <div class="copyright">
                <strong><span> جميع الحقوق محفوظة </span></strong> &copy; جامعة كربلاء / كلية علوم الحاسوب وتكنولوجيا
                المعلومات
            </div>
            <div class="credits">
