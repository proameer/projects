...
<html lang="en">
    ...
    $i=1;
    $id=$_GET['id_r'];
      $result = mysqli_query($conn,"SELECT id_r , name_house , status , area , room_no , price , email , phone , description  ,category_name FROM request_houses JOIN categories  ON request_houses.category_id=categories.id WHERE id_r='$id'");
