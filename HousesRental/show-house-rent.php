  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-12" style="direction:rtl">
            <div class="title-single-box">
              <h1 class="title-single"> العقارات المعروضة للايجار</h1>
            </div>
          </div>
    ...
    <section class="agent-single" style="direction: rtl;">
      <div class="container">
                  ...
                  $result = mysqli_query($conn,"SELECT name_house , status , area , room_no , price , email , phone , description , img ,category_name FROM show_houses JOIN categories  ON show_houses.category_id=categories.id where status='ايجار' order by id_s desc");
