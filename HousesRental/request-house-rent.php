  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-12" style="direction:rtl">
            <div class="title-single-box">
              <h1 class="title-single">العقارات المطلوبة للايجار</h1>
            </div>
          </div>
    ...
    <section class="agent-single" style="direction: rtl;">
      <div class="container">
                  ...
                  $result = mysqli_query($conn,"SELECT name_house , status , area , room_no , price , email , phone , description  ,category_name FROM request_houses JOIN categories  ON request_houses.category_id=categories.id where status='ايجار' order by id_r desc");
                  while ($row = mysqli_fetch_array($result)) {

                   ?>
  <div class="row mb-4" style="border-radius: 15px; border: 2px solid; padding: 5px; ">
    <div class="col-sm-12">
      <div class="row">
        ...
        <div class="col-md-7 agent-title" style="border-right:3px dotted">
          <h4  style="display: inline-block;"> التفاصيل </h4>
          <hr>
