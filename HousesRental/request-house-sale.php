  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-12" style="direction:rtl">
            <div class="title-single-box">
              <h1 class="title-single">العقارات المطلوبة للبيع</h1>
            </div>
          </div>
    ...
    <section class="agent-single" style="direction: rtl;">
      <div class="container">
                  ...
                  $result = mysqli_query($conn,"SELECT name_house , status , area , room_no , price , email , phone , description  ,category_name FROM request_houses JOIN categories  ON request_houses.category_id=categories.id where status='بيع' order by id_r desc");
