            ...
            <div class="container-fluid" style="margin: 0 240px;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h1 style="text-align:center " class="card-title"> ادارة المستخدمين </h1>
...
{
    $q=mysqli_query($conn,"SELECT * from users where name like '%$_POST[search]%' or email like '%$_POST[search]%' ORDER BY id desc");

    if(mysqli_num_rows($q)==0)
      {
        echo "<h1 style='padding-top: 100px;
        text-align: center;'>عفوا لا يوجد مستخدم بهذا الاسم. حاول البحث مره اخرى</h1>";
      }
            else{ ?>
...
?>
                                            <tr>
                                                ...
                                                <td><a href="manage-users.php?id=<?php echo $row['id'];?>"><button
